...
function TimelineCard({
  ...
  return (
    <div className="h-full rounded-xl border border-white/10 bg-black/10 p-4 dark:bg-black/20 sm:rounded-[1.75rem] sm:p-5">
      ...
      <div className="mt-4 space-y-1.5 sm:space-y-2">
        {entries.map((entry) => (
          <div
            className="rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-xs text-white/78 transition-colors hover:bg-white/8 sm:rounded-2xl sm:px-4 sm:py-3"
            key={entry}
          >
            {entry}
          </div>
